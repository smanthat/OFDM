...
REM
REM Generated by Vivado on Fri Jun 26 20:15:14 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_bit_rom_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_bit_rom_vlog.prj -log xvlog.log
