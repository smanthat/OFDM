...
REM
REM Generated by Vivado on Thu Jun 25 10:43:23 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_frame_sequencer_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_frame_sequencer_vlog.prj -log xvlog.log
