...
REM
REM Generated by Vivado on Fri Jun 26 11:10:16 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_cp_insert_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_cp_insert_vlog.prj -log xvlog.log
