...
#
# Script generated by Vivado on Fri Jun 26 18:38:41 -0500 2026
...
export RDI_DATADIR="C:/Sourish/2025.2/Vivado/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_14 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_generator_0 xil_defaultlib.fifo_generator_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Sourish/2025.2/Vivado/data/xsim"
  fi
